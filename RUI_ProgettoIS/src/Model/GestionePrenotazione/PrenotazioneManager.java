...
public class PrenotazioneManager {
	 ...
	 * @pre Prenotazione-> exists(prenotazione)
	 */
	 ...
	 * @throws SQLException the SQL exception
	 * @pre Prenotazione-> exists(p|p.matricolaDocente==matricolaDocente)
	 */
	 ...
	 * @throws SQLException the SQL exception
	 * @pre Prenotazione-> exists(p|p.matricolaStudente==matricolaStudente)
	 */
	 ...
	 * @throws SQLException the SQL exception
	 * @pre prenotazione.id !=null && prenotazione.ora!=null && prenotazione.data!=null && prenotazione.matricolaDocente!=null && prenotazione.matricolaStudente!=null
	 */
	public static String agPrenotazione(Prenotazione pre) throws SQLException {
	 ...
	 * @return true se l'operazione va a buon fine altrimenti false
	 * @throws SQLException the SQL exception
	 * @pre p.id !=null  && dato!=null && action !=null && avviso->exists(p|p.id==id)
	 */
