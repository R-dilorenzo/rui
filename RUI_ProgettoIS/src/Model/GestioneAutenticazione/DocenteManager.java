...
public class DocenteManager {
	 ...
	 * @return true se l'operazione va a buon fine altrimenti false
	 * @pre docente!=null || docente.email !=null || docente.nome !=null || docente.cognome != null || docente.password !=null || docente.insegnamento1 != null
	 */
	 ...
	 * @return true se l'operazione va a buon fine altrimenti false
	 * @pre matricola !=null && docente->exists(d|d.matricola==matricola)
	 */
	 ...
	 * @return true se l'operazione va a buon fine altrimenti false
	 * @pre Docente-> exists(d|d.matricola==matricola)
	 */ 
	 ...
	 * @return true se l'operazione va a buon fine altrimenti false
	 * @pre Pre:Docente-> exists(d|d.matricola==matricola)
	 */
	 ...
	 * @return true se l'operazione va a buon fine altrimenti false
	 * @pre Docente-> exists(d|d.email==email)
	 */
