...
/**
 * The Class AvvisoManager.
 */
public class AvvisoManager {
	
	/**
	 * Instantiates a new avviso manager.
	 */
	private AvvisoManager() {
	...
	/**
	 * Restituisce un array ontenente una lista di tutti gli avvisi pubblicati dal
	 * docente .
	 *
	 * @param matricolaDocente dato secondo cui distinguere gli avvisi
	 * @return la lista di avvisi
	 * @throws SQLException the SQL exception
	 * @pre Avviso-> exists(a|a.matricolaDocente==matricolaDocente)
	 */
	 ...
	 * @throws SQLException the SQL exception
	 * @pre avviso.id !=null && avviso.nomeAvviso!=null && avviso.oraAvviso!=null && avviso.data!=null && avviso.matricolaDocente!=null
	 */
	 ...
	 * @return true se l'operazione va a buon fine altrimenti false
	 * @throws SQLException the SQL exception
	 * @pre a.id !=null && dato!=null && action !=null && avviso->exists(a|a.id==id)
	 */
